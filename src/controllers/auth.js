...
export const loginUserCtrlr = async (req, res) => {
  ...
  res.cookie('refreshToken', session.refreshToken, {
    httpOnly: true,
    secure: true, // вимагає HTTPS на продакшені -> в Postman не працює --> не надсилає cookie
    sameSite: 'none', // none -> cookie буде доступна на стороні клієнта --> працює крос-доменна передача
